...
def processar_comando(comando):
    ...
    if "chaves" in comando:  # Se o comando contiver "chaves"
        ...
        pygame.mixer.music.load("chaves-isso-isso-isso.mp3")  # Carrega o arquivo MP3
    ...
    if comando == "ligar lâmpada":  # Se o comando for "ligar lâmpada"
        ...
        pygame.mixer.music.load("queBurro.mp3")  # Carrega o arquivo MP3
        pygame.mixer.music.play() # Reproduz o áudio
        while pygame.mixer.music.get_busy(): # Aguarda até que o áudio termine
            pygame.time.Clock().tick(10)
        
        pygame.mixer.music.load("senhor-barriga-tinha-que-ser-o-chaves-de-novo.mp3")  # Carrega o arquivo MP3
        pygame.mixer.music.play() # Reproduz o áudio
        while pygame.mixer.music.get_busy(): # Aguarda até que o áudio termine
            pygame.time.Clock().tick(10)
